...
<body>
	...
	<header class="bgimg-1 w3-display-container w3-grayscale-min" id="AllAirlines">
        ...
        <div class="w3-display-centre w3-text-black" style="padding:48px" class="w3-container">
           <p align="center"> <span class="w3-xxlarge" >Flight List</span></p> 

           <span class="w3-xlarge">Available Flights</span>
        </div>
        <br/>
        <div class="w3-display-left w3-text-red" style="padding:48px"  >
            <span class="w3-xxlarge">Sorry there is no flights available with your search criteria</span>
</div>
	 <div class="w3-display-left w3-text-white" style="padding:48px ;position:relative; top:370px;">
        <p><a href="Search_Flights.jsp" class="w3-button w3-white w3-padding-large w3-large w3-margin-top w3-opacity w3-hover-opacity-on"><i class="fa fa-gear"></i>   Search again</a></p>
        </div>
	</header>
<div class="footer">
